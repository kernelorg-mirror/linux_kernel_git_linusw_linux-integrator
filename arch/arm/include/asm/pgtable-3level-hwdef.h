 ...
 */
#if defined CONFIG_CPU_TTBR0_PAN || defined CONFIG_ARM_KERNEL_IN_VMALLOC
...
/*
 * With CONFIG_CPU_TTBR0_PAN or CONFIG_ARM_KERNEL_IN_VMALLOC enabled, TTBR1
 * is only used during uaccess disabled regions when TTBR0 is disabled.
 */
#if defined CONFIG_CPU_TTBR0_PAN || defined CONFIG_ARM_KERNEL_IN_VMALLOC
#define TTBR1_SIZE	0
#else
